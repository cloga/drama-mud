export type IntroTextBlock = { type: 'title' | 'heading' | 'paragraph' | 'quote'; content: string }
export type IntroBlock = IntroTextBlock | { type: 'list'; items: string[] }
...
export function parseWorldMarkdown(markdown: string): IntroBlock[] {
